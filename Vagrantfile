...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    yum install -y --nogpgcheck kernel-devel kernel-headers vim wget
    wget -q https://download.virtualbox.org/virtualbox/${vboxVersion}/VBoxGuestAdditions_${vboxVersion}.iso
